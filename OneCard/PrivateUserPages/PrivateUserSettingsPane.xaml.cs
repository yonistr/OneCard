...
namespace OneCard
{
    public sealed partial class PrivateUserSettingsPane : UserControl
    {
        public PrivateUserSettingsPane()
        {
        ...
        private void AllCardsOpensButton(object sender, RoutedEventArgs e)
        {

        }

        private void FavoritesOpensButton(object sender, RoutedEventArgs e)
        {
